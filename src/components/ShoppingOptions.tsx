    ...
    <section className="py-20 bg-gradient-to-br from-green-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-3">
              ...
              {user ? (
                <Link 
                  to="/customize"
                  className="w-full border-2 border-green-600 text-green-600 py-3 px-6 rounded-full font-semibold hover:bg-green-50 transition-colors text-center block"
                >
                  Customize Your Leafy Bucket
                </Link>
              ) : (
                <div className="w-full border-2 border-gray-300 text-gray-500 py-3 px-6 rounded-full font-semibold text-center bg-gray-50 cursor-not-allowed">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            ...
            <div className="bg-orange-50 rounded-2xl p-4 mb-6">
              <div className="text-center">
                <div className="text-sm text-orange-700 mb-1">Individual prices</div>
                <div className="text-3xl font-bold text-orange-600">LKR 100+</div>
                <div className="text-sm text-orange-700">per item</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <Link 
                to="/shop"
                className="w-full bg-orange-600 text-white py-4 px-6 rounded-full font-semibold hover:bg-orange-700 transition-colors flex items-center justify-center space-x-2 group"
              >
              ...
              <Link 
                to="/products"
                className="w-full border-2 border-orange-600 text-orange-600 py-3 px-6 rounded-full font-semibold hover:bg-orange-50 transition-colors text-center block"
              >
                View All Vegetables
              </Link>
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="text-center py-4 px-4 font-semibold text-orange-600">Individual Shopping</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                ...
                <tr>
                  ...
                  <td className="py-4 px-4 text-center">
                    <div className="text-orange-600 font-semibold">High</div>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4 text-center">
                    <div className="text-orange-600 font-semibold">Standard</div>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4 text-center">
                    <div className="text-orange-600 font-semibold">None</div>
